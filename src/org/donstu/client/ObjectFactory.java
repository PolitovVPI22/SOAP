...
public class ObjectFactory {
    ...
    private final static QName _PlaceOrder_QNAME = new QName("https://donstu.org/orders", "placeOrder");
    private final static QName _GetAllProducts_QNAME = new QName("https://donstu.org/orders", "getAllProducts");
    private final static QName _GetAllOrders_QNAME = new QName("https://donstu.org/orders", "getAllOrders");
    private final static QName _GetAllProductsResponse_QNAME = new QName("https://donstu.org/orders", "getAllProductsResponse");
    private final static QName _GetAllOrdersResponse_QNAME = new QName("https://donstu.org/orders", "getAllOrdersResponse");
    private final static QName _PlaceOrderResponse_QNAME = new QName("https://donstu.org/orders", "placeOrderResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://donstu.org/orders", name = "placeOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://donstu.org/orders", name = "getAllProducts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://donstu.org/orders", name = "getAllOrders")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://donstu.org/orders", name = "getAllProductsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://donstu.org/orders", name = "getAllOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "https://donstu.org/orders", name = "placeOrderResponse")
